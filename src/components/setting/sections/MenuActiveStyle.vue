<template>
  <div>
    <h6 class="mt-4 mb-3">Estilo Activa de barra lateral </h6>
    <div class="d-grid gap-3 grid-cols-2 mb-4">
      <radio-input btn-name="sidebar_menu_style" :img-component="true" labelClass="p-0 d-block overflow-hidden" label-title="Pegado" class-name="text-center" id="navs-rounded" :default-checked="sidebarMenuStyle" value="sidebar-default navs-rounded" @onChange="updateRadio">
      ...
      <radio-input btn-name="sidebar_menu_style" :img-component="true" labelClass="p-0 d-block overflow-hidden" label-title="Separado" class-name="text-center" id="navs-rounded-all" :default-checked="sidebarMenuStyle" value="sidebar-default navs-rounded-all" @onChange="updateRadio">
      ...
      <radio-input btn-name="sidebar_menu_style" :img-component="true" labelClass="p-0 d-block overflow-hidden" label-title="Redondeado un lado" class-name="text-center" id="navs-pill" :default-checked="sidebarMenuStyle" value="sidebar-default navs-pill" @onChange="updateRadio">
      ...
      <radio-input btn-name="sidebar_menu_style" :img-component="true" labelClass="p-0 d-block overflow-hidden" label-title="Redondeado" class-name="text-center" id="navs-pill-all" :default-checked="sidebarMenuStyle" value="sidebar-default navs-pill-all" @onChange="updateRadio">
