<template>
  <div>
    <h6 class="mb-3">Tipos de barra lateral</h6>
    <div class="d-grid gap-3 grid-cols-3 mb-3 text-center">
      ...
      <checkbox-input btn-name="sidebar_type" :imgComponent="true" label-title="Superpuesta" id="sidebar-hover" label-class="p-0" :default-checked="menuStyle.value" value="sidebar-hover" @onChange="updateCheckbox">
      ...
      <checkbox-input btn-name="sidebar_type" :imgComponent="true" label-title="Encajada" id="sidebar-boxed" label-class="p-0" :default-checked="menuStyle.value" value="sidebar-boxed" @onChange="updateCheckbox">
